...
/**
 * Measures transaction throughput for deployed smart contracts
 */
...
// Program IDs
const PROGRAM_IDS = {
  escrow: "4cxUnCwFNdjbg33t8Di6DwA18c55oXkvtXWXC3sdMUdo",
  crowdfunding: "3AXDMAXWYu3iGxgdqPv7Z6Xwyqytx9nJ2EB91qzGEf5J",
};
...
async function confirmTransaction(connection, signature) {
  try {
    ...
    const confirmation = await connection.confirmTransaction({
      signature,
      lastValidBlockHeight: status.context.slot + 150,
